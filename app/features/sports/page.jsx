            ...
            <section class="text-gray-400 bg-gray-700 body-font">
                <div class="container px-5 py-24 mx-auto flex flex-wrap">
                    <div class="lg:w-1/2  w-full mb-10 lg:mb-0 rounded-lg overflow-hidden flex center justify-center"
                        ...
                        <img alt="feature" class="object-cover  object-center h-full w-full" src="https://thumbs.dreamstime.com/b/soccer-team-practicing-football-ground-teenagers-playing-field-182546504.jpg"
                        />
                    </div>
