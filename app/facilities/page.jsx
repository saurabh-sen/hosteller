...
const page = () => {
  return (
    <div>
      <NavBar />
      <section className="text-gray-400 bg-gray-700 body-font border-b border-gray-600">
        <div className="container px-5 py-24 mx-auto">
          <div className="text-center mb-20">
            <h1 className="sm:text-3xl text-2xl font-medium title-font text-white mb-4">Facillities We Provide</h1>
            ...
            <div className="flex mt-6 justify-center">
              <div className="w-16 h-1 rounded-full bg-[#ff8a49] inline-flex"></div>
            </div>
          </div>
          <div className="flex flex-wrap sm:-m-4 -mb-10 -mt-4 space-x-2 md:space-y-0 space-y-6 justify-evenly">
            <div className="p-4 md:w-1/4 flex s flex-col text-center items-center cursor-pointer transition-shadow duration-200 hover:shadow-[11px_11px_28px_#272e3a,-11px_-11px_28px_#475468] border border-gray-600 rounded-lg" >
              <div className="w-20 h-20 inline-flex items-center justify-center rounded-full  mb-5 flex-shrink-0"
                style={{
                  boxShadow: "inset 11px 11px 28px #272e3a,inset -11px -11px 28px #475468"
                }} >
              ...
              <div className="flex-grow">
                ...
                <Link className="mt-3 text-red-400 inline-flex items-center" href='/facilities/security'>Learn More
            ...
            <div className="p-4 md:w-1/4 flex s flex-col text-center items-center cursor-pointer transition-shadow duration-200 hover:shadow-[11px_11px_28px_#272e3a,-11px_-11px_28px_#475468] border border-gray-600 rounded-lg">
              ...
              <div className="flex-grow">
                ...
                <p className="leading-relaxed text-base">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine, ramps microdosing banh mi pug VHS try-hard.</p>
                <Link className="mt-3 text-red-400 inline-flex items-center" href='/facilities/homelkeenvironmeint' >Learn More
                  <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
                    <path d="M5 12h14M12 5l7 7-7 7"></path>
                  </svg>
                </Link>
            ...
            <div className="p-4 md:w-1/4 flex s flex-col text-center items-center cursor-pointer transition-shadow duration-200 hover:shadow-[11px_11px_28px_#272e3a,-11px_-11px_28px_#475468] border border-gray-600 rounded-lg">
              ...
              <div className="flex-grow">
                ...
                >Sports</h2>
                <p className="leading-relaxed text-base">Blue bottle crucifix vinyl post-ironic four dollar toast vegan taxidermy. Gastropub indxgo juice poutine, ramps microdosing banh mi pug VHS try-hard.</p>
                <Link className="mt-3 text-red-400 inline-flex items-center" href='/facilities/sports' >Learn More
                  <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" className="w-4 h-4 ml-2" viewBox="0 0 24 24">
                    <path d="M5 12h14M12 5l7 7-7 7"></path>
                  </svg>
                </Link>
          ...
          <button className="mt-16 group learn-more relative cursor-pointer outline-0 border-0 align-middle bg-transparent w-48 h-auto flex mx-auto">
            <span className="circle group transition-all duration-500 ease-in-out relative block w-full h-12 bg-[#282936] rounded-full" aria-hidden="true"
              style={{ boxShadow: "inset 5px 5px 10px #10161e, inset -5px -5px 10px #2e3e52" }}
            >
              <span className="icon transition-all duration-500 ease-in-out arrow left-2 w-6 h-6 bg-none before:absolute before:content-[''] before:top-4 before:right-5 before:w-4 before:h-4 before:border-t-2 before:border-r-2 before:rotate-45 group-hover:bg-gray-400 group-hover:translate-x-4"></span>
            </span>
            <span className="button-text transition-all duration-500 ease-in-out absolute top-0 left-0 right-0 bottom-0 py-3 text-gray-500 uppercase group-hover:text-gray-400">Learn More</span>
          </button>
